class AudioPlayer {
    ...
    set index(value){
        ...
        console.log("yo soy el index",this.index);
        console.log("yo soy el arreglo de songs",songs.length);
        console.log(this.index + value >= 0)
        console.log(this.index + value < this.songs.length)
        if( value >= 0 && value < songs.length ){
            this._index = value;
            this.loadSong();
        }else{
    ...
    set buttons(btns) {
        let actions = {
            ...
            back: () => {
                this.index--; this.player.play();
                //this._toggleIcon(this.buttons.playPause, "fa-pause", "fa-play");
                this._togglePlayIcon(this.buttons.playPause);
            ...
            //next: () => {this.index++; this.player.play();this._toggleIcon(this.buttons.playPause, "fa-pause", "fa-play");},
